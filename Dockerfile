...
RUN cd /opt && wget http://d3kbcqa49mib13.cloudfront.net/spark-2.0.1-bin-hadoop2.7.tgz && tar xvf spark-2.0.1-bin-hadoop2.7.tgz && mv spark-2.1.0-bin-hadoop2.7 spark
